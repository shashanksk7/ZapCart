...
import Image1 from "../../src/assets/hero/img3.jpg";
import Image2 from "../../src/assets/hero/img2.jpg";
import Image3 from "../../src/assets/hero/img01.avif";

const ImageList = [
  {
    id: 1,
    img: Image1,
    title: "Upto 50% off on all TVs & Appliances",
    description:
            ...
            <div key={data.id} className="grid grid-cols-1 sm:grid-cols-2">
              ...
              <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300">
                  {/* Using NavLink Instead of Button */}
                  <NavLink
                    to="/products"
                    className="bg-gradient-to-r from-primary to-secondary hover:scale-105 duration-200 text-white py-2 px-4 rounded-full inline-block"
                  >
                    Shop Now
                  </NavLink>
                </div>
